        ...
        if guidance_type == "uncond":
            ...
            if guidance_scale == 1. or unconditional_condition is None:
                ...
                if isinstance(condition, (list, dict)):
                    c_in = [unconditional_condition, condition]
                else:
...
class DPM_Solver(manager):
    def __init__(
        ...
        **kwargs,
        ...
        self.model_run = lambda x, t: model_fn(x, t.expand((x.shape[0])))
        ...
        with torch.no_grad():
            if method == 'adaptive':
                ...
                for step in range(order, steps + 1):
                    ...
                    #@Wenxuan
                    self.on_step_end(cur_step=step + 1, max_steps=steps + 1, **kwargs)
